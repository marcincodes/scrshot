...
import docs__screenshotsMdx from './docs__screenshots.mdx.json' assert { type: 'json' }
...
export const allDocs = [docs__inProgressMdx, docs__indexMdx, docs__screenshotsMdx, docs__documentation__codeBlocksMdx, docs__documentation__componentsMdx, docs__documentation__indexMdx, docs__documentation__styleGuideMdx]
